...
- Say that your plugin, theme, template, or tool works with Longhand, reads or writes the Longhand vault spec, or imports into Longhand.
- Use the name in truthful descriptions and reviews.
- Show the marks when linking to the project, unmodified, from the files in the brand kit.

You may not:

- Name a fork, a product, a service, or a company "Longhand", "Nib", or something confusingly close, or use the marks as your own.
